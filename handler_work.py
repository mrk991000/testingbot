...
def register_handlers(router, bot: Bot, client, OWNER_ID):
    ...
    async def chatgpt_text_handler(message: Message):
        ...
        response = await message.answer("⏳ Please wait, your request is being processed!")
    ...
    async def chatgpt_photo_vision_handler(message: types.Message, state: FSMContext):
        ...
        try:
            ...
            text = message.caption or "What is in the picture?"
        ...
        try:
            ...
            if message.voice:
                try:
                    ...
                    await message.answer("⚠️ Voice recognition error")
                    return
